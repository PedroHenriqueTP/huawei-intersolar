...
@Injectable()
export class BikeEnergyPlugin extends IActivationPlugin {
  readonly type = ActivationType.BIKE_ENERGY;
  readonly name = 'Bike Energy';
  ...
  getSocraticFeedback(userName: string, score: number): string {
    return `Incrível, ${userName}! Você gerou ${score}W pedalando, o suficiente para alimentar uma geladeira inverter Huawei por 4 horas!`;
  }
